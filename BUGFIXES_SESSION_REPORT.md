...
### 1. ✅ Замена Daily.co на Jitsi Meet (бесплатное решение)
**Проблема**: Daily.co - платный сервис  
**Решение**: Интеграция Jitsi Meet - полностью бесплатный WebRTC сервис

**Изменения**:
- Создан `src/components/video/JitsiVideoCall.tsx`
- Обновлён `src/pages/VideoCalls.tsx`
- Динамическая загрузка Jitsi API
- Полная функциональность: аудио, видео, демонстрация экрана, чат
...
**Коммит**: `feat: замена Daily.co на Jitsi Meet (бесплатно), исправлена фильтрация событий в Dashboard`
...
**Коммит**: Включено в тот же коммит с Jitsi
