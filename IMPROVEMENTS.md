# 🚀 DOMIO Ops - Масштабирование до мирового уровня
...
# 6. Синхронизируйте с нативными платформами
npx cap sync

# 7. Запустите на устройстве
npx cap run android
# или
npx cap run ios  # требуется Mac с Xcode
```
